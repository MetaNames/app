...
## 2024-11-23 - Sort with array destructuring
**Learning:** Creating temporary arrays or using object destructuring inside an `Array.prototype.sort()` callback (e.g., `[a, b][condition ? 'slice' : 'reverse']()`) introduces Garbage Collection overhead and slows down operations.
