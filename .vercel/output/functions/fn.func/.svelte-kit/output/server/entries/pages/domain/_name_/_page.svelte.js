import { c as create_ssr_component, a as compute_rest_props, g as get_current_component, d as spread, e as escape_object, f as add_attribute, b as getContext, s as setContext, o as onDestroy, v as validate_component, m as missing_component, i as subscribe, j as escape } from "../../../../chunks/ssr.js";
import { p as page } from "../../../../chunks/stores2.js";
import "@metanames/sdk";
import { i as is_void, g as globals, m as metaNamesSdk } from "../../../../chunks/stores.js";
import "../../../../chunks/SelectionGroupIcon.js";
import "../../../../chunks/Suffix.js";
import "../../../../chunks/ActionIcons.js";
import { C as CircularProgress } from "../../../../chunks/Subtitle.js";
import "jdenticon";
...
const Record_svelte_svelte_type_style_lang = "";
const Records_svelte_svelte_type_style_lang = "";
const Domain_svelte_svelte_type_style_lang = "";
const _page_svelte_svelte_type_style_lang = "";
const css = {
  code: ".domain.svelte-15rm0ip{min-width:60vw}@media(max-width: 768px){.domain.svelte-15rm0ip{min-width:90vw}}",
  map: null
};
const Page = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let pageName;
  let $$unsubscribe_page;
  let $$unsubscribe_metaNamesSdk;
  $$unsubscribe_page = subscribe(page, (value) => value);
  $$unsubscribe_metaNamesSdk = subscribe(metaNamesSdk, (value) => value);
  $$result.css.add(css);
  pageName = "";
  $$unsubscribe_page();
  $$unsubscribe_metaNamesSdk();
  return `${$$result.head += `<!-- HEAD_svelte-11yaobx_START -->${$$result.title = `<title>${escape(pageName)}Meta Names</title>`, ""}<!-- HEAD_svelte-11yaobx_END -->`, ""} <div class="content domain svelte-15rm0ip">${`${`${validate_component(CircularProgress, "CircularProgress").$$render(
    $$result,
    {
