import { c as create_ssr_component, a as compute_rest_props, g as get_current_component, b as getContext, v as validate_component, m as missing_component, d as spread, e as escape_object, f as add_attribute, s as setContext, h as escape_attribute_value, o as onDestroy, i as subscribe, j as escape, n as null_to_empty } from "../../chunks/ssr.js";
...
import { d as dispatch, R as Ripple } from "../../chunks/Ripple.js";
import { g as globals, m as metaNamesSdk, w as walletAddress } from "../../chunks/stores.js";
import "partisia-sdk";
import { B as Button, C as CommonLabel } from "../../chunks/Button.js";
import { T as Text } from "../../chunks/SelectionGroupIcon.js";
...
const walletConnect = "";
const WalletConnect_svelte_svelte_type_style_lang = "";
const css$3 = {
  code: ".logo.svelte-2y8y06{height:20pt;width:20pt;margin-right:0.8rem}.item.svelte-2y8y06{display:flex;flex-direction:row;align-items:center}",
  map: null
};
const WalletConnect = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let buttonLabel;
  let $$unsubscribe_metaNamesSdk;
  let $shortAddress, $$unsubscribe_shortAddress;
  $$unsubscribe_metaNamesSdk = subscribe(metaNamesSdk, (value) => value);
  const shortAddress = derived(walletAddress, ($address) => {
    if ($address)
      return $address.slice(0, 4) + "..." + $address.slice(-4);
  });
  $$unsubscribe_shortAddress = subscribe(shortAddress, (value) => $shortAddress = value);
  let menu;
  let { anchor } = $$props;
  if ($$props.anchor === void 0 && $$bindings.anchor && anchor !== void 0)
    $$bindings.anchor(anchor);
      ...
      },
      {
        default: () => {
          return `${validate_component(List, "List").$$render($$result, {}, {}, {
            default: () => {
              return `${$shortAddress ? `${validate_component(Item, "Item").$$render($$result, {}, {}, {
                default: () => {
                ...
                default: () => {
                  return `${validate_component(Text, "Text").$$render($$result, {}, {}, {
                    default: () => {
                      return `<div class="item svelte-2y8y06" data-svelte-h="svelte-goc29f"><img class="logo svelte-2y8y06" src="/images/metamask.svg" alt="metamask wallet logo"> <span>Meta Mask Wallet</span></div>`;
                    }
                  })}`;
                }
              })} ${validate_component(Item, "Item").$$render($$result, {}, {}, {
                default: () => {
                  return `${validate_component(Text, "Text").$$render($$result, {}, {}, {
                    default: () => {
                      return `<div class="item svelte-2y8y06" data-svelte-h="svelte-1ov0ir1"><img class="logo svelte-2y8y06" src="/images/partisia-wallet.svg" alt="partisia wallet logo"> <span>Partisia Wallet</span></div>`;
                    }
                  })}`;
                }
              })}`}`;
  ...
  $$unsubscribe_shortAddress();
  return $$rendered;
});
const Logo_svelte_svelte_type_style_lang = "";
const css$2 = {
  code: "svg.svelte-1apcq6f{width:3rem;height:4rem}.st0.svelte-1apcq6f{fill:#fff}",
  map: null
};
const Logo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$2);
  return `<svg version="1.1" id="meta_names" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 -200 800 900" xml:space="preserve" class="svelte-1apcq6f"><g><g><path class="st0 svelte-1apcq6f" d="M400,46.88L400,46.88c-65.52,0-118.63,53.11-118.63,118.63v72.81c25.72,0,46.58-20.85,46.58-46.58v-29.28
			...
			z"></path><path class="st0 svelte-1apcq6f" d="M400,452.99L400,452.99c65.52,0,118.63-53.11,118.63-118.63v-72.81c-25.72,0-46.58,20.85-46.58,46.58v29.28
...
const css$1 = {
  code: ".logo.svelte-1k2txxl{display:flex;flex-direction:row;align-items:center}.links.svelte-1k2txxl{display:flex;flex-direction:column;align-items:center}a.svelte-1k2txxl,span.svelte-1k2txxl{color:var(--mdc-theme-on-primary)}footer.svelte-1k2txxl{display:flex;flex-direction:row;justify-content:space-evenly;align-items:center;padding:1rem;background-color:var(--mdc-theme-primary);@media only screen and (max-width: 600px) {\n			flex-direction: column;\n		};border-top:1px solid var(--mdc-theme-secondary)}",
  map: null
};
const Footer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<footer class="svelte-1k2txxl"><div class="logo svelte-1k2txxl">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})} <span class="svelte-1k2txxl" data-svelte-h="svelte-1vz907r">Meta Names</span></div> <div class="links svelte-1k2txxl" data-svelte-h="svelte-mz61q"><a href="mailto:metanames@proton.me" target="_blank" class="svelte-1k2txxl">Contact us</a> <a href="https://x.com/metanames_" target="_blank" class="svelte-1k2txxl">Twitter</a></div> </footer>`;
});
const _layout_svelte_svelte_type_style_lang = "";
const css = {
  code: ".link-logo.svelte-1jz4r9p{display:flex;flex-direction:row;align-items:center;text-decoration:none;color:inherit}main.svelte-1jz4r9p{display:flex;flex-direction:column;align-items:stretch;gap:1rem;min-height:100vh;background-color:var(--mdc-theme-background)}.logo.svelte-1jz4r9p{color:white}",
  map: null
};
const Layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  let anchorClasses = {};
  $$result.css.add(css);
  return `<main class="svelte-1jz4r9p">${validate_component(TopAppBar, "TopAppBar").$$render($$result, { variant: "static" }, {}, {
    default: () => {
      return `<div class="${escape(null_to_empty(Object.keys(anchorClasses).join(" ")), true) + " svelte-1jz4r9p"}"${add_attribute("this", anchor, 0)}>${validate_component(Row, "Row").$$render($$result, {}, {}, {
        default: () => {
          return `${validate_component(Section, "Section").$$render($$result, {}, {}, {
            default: () => {
              return `${validate_component(Title, "Title").$$render($$result, {}, {}, {
                default: () => {
                  return `<a class="link-logo svelte-1jz4r9p" href="/">${validate_component(Logo, "Logo").$$render($$result, {}, {}, {})} <span data-svelte-h="svelte-1vz907r">Meta Names</span></a>`;
                }
              })}`;
            }
          })} ${validate_component(Section, "Section").$$render($$result, { align: "end", toolbar: true }, {}, {
            default: () => {
              return `${validate_component(WalletConnect, "WalletConnect").$$render($$result, { anchor }, {}, {})}`;
            }
          })}`;
        }
      })}</div>`;
    }
  })} ${slots.default ? slots.default({}) : ``} ${validate_component(Footer, "Footer").$$render($$result, {}, {}, {})} </main>`;
});
export {
  Layout as default
};
