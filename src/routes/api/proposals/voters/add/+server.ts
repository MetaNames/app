...
export async function GET() {
  ...
  const { transactionHash, fetchResult } = await metaNamesSdk.contractRepository.createTransaction({ contractAddress: config.tldMigrationProposalContractAddress, payload, gasCost: 'medium' })
